...
const Calculator: React.FC = () => {
  ...
  const renderScientificExtras = () => (
    <Grid columns={4} gap="2">
      <CalcKey variant="soft" colorScheme="accent" onClick={factorial}>x!</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={() => performOperation('pow')} icon={<Power size={16} />} />
      <CalcKey variant="soft" colorScheme="accent" onClick={sin}>sin</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={cos}>cos</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={tan}>tan</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={asin}>asin</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={acos}>acos</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={atan}>atan</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={sinh}>sinh</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={cosh}>cosh</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={tanh}>tanh</CalcKey>
      <CalcKey variant="soft" colorScheme="accent" onClick={() => performOperation('mod')}>mod</CalcKey>
    </Grid>
  );
    ...
    <Stack gap="3">
      <Alert status="info" variant="soft">
        <AlertDescription>
          ...
          <Badge
            variant="soft"
            colorScheme={isBalanced ? 'success' : 'danger'}
            size="xs"
          >
            {isBalanced ? 'Yes' : 'No'}
          </Badge>
      ...
      <Stack gap="4">
            ...
            <Inline justify="between" align="center" wrap gap="2">
              ...
              <Inline gap="1">
                <IconButton
                  ...
                  colorScheme={showMemoryPanel ? 'accent' : 'neutral'}
                  size="sm"
                  label="Memory"
                ...
                <IconButton
                  ...
                  colorScheme={showFavorites ? 'warning' : 'neutral'}
                  size="sm"
                ...
                <Inline justify="between" align="center" gap="2" wrap>
                  <ButtonGroup>
                    <Button
                      ...
                      colorScheme={angleUnit === 'deg' ? 'accent' : 'neutral'}
                      size="sm"
                    ...
                    <Button
                      ...
                      colorScheme={angleUnit === 'rad' ? 'accent' : 'neutral'}
                      size="sm"
        ...
        {showMemoryPanel && (
          <Card variant="elevated" size="md">
            ...
            <CardBody>
              <Stack gap="2">
                {memories.map((mem, i) => (
                  <Card key={mem.label} variant="filled" size="sm">
                    <CardBody>
                      <Inline justify="between" align="center" gap="2" wrap>
                        ...
                        <ButtonGroup>
                          <Button variant="soft" colorScheme="neutral" size="xs" onClick={() => memoryRecall(i)}>MR</Button>
                          <Button variant="soft" colorScheme="neutral" size="xs" onClick={() => memoryAdd(i)}>M+</Button>
                          <Button variant="soft" colorScheme="neutral" size="xs" onClick={() => memorySubtract(i)}>M-</Button>
                          <Button variant="soft" colorScheme="danger" size="xs" onClick={() => memoryClear(i)}>MC</Button>
                        </ButtonGroup>
                      </Inline>
                    </CardBody>
                  </Card>
        ...
        {calculationHistory.length > 0 && (
          <Card variant="elevated" size="md">
            ...
            <CardBody>
              <Box overflow="auto" maxHeight="24rem">
                <Stack gap="2">
                  {calculationHistory.map((item, idx) => {
                    ...
                    return (
                      <Card key={idx} variant="filled" size="sm">
                        <CardBody>
                          <Stack gap="1">
                            ...
                            <Inline>
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  if (parts.length === 2) handleUseResult(parts[1]);
                                }}
                              >
                                Use result
                              </Button>
